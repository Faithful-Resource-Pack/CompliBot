...
module.exports = {
  ...
  pathToTextureURL: function (path, edition, res, version = undefined) {
    if (edition.toLowerCase() === 'java') {
      ...
      if (res == 32) return settings.repositories.raw.faithful_32x.java + (version === undefined ? settings.versions.java.sort(sorterMC).reverse()[0] : version) + '/' + path
      if (res == 64) return settings.repositories.raw.faithful_64x.java + (version === undefined ? settings.versions.java.sort(sorterMC).reverse()[0] : version) + '/' + path
    }
      ...
      if (res == 32) return settings.repositories.raw.faithful_32x.bedrock + (version === undefined ? settings.versions.bedrock[0] : version) + '/' + path
      if (res == 64) return settings.repositories.raw.faithful_64x.bedrock + (version === undefined ? settings.versions.bedrock[0] : version) + '/' + path
    }

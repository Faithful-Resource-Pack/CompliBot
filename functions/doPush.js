 ...
 */
async function doPush(COMMIT_MESSAGE = `githubPush passed textures from ${date()}`) {

	/* JAVA 32x *********************************************************************************************************************/
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.17/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.17', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.17/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.16.5/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.16.5', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.16.5/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.15.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.15.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.15.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.14.4/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.14.4', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.14.4/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.13.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.13.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.13.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-32x/1.12.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-32x', 'Jappa-1.12.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-32x/1.12.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.17/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.17', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.17/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.16.5/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.16.5', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.16.5/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.15.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.15.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.15.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.14.4/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.14.4', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.14.4/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.13.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.13.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.13.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Java-64x/1.12.2/assets`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Java-64x', 'Jappa-1.12.2', COMMIT_MESSAGE, './texturesPush/Compliance-Java-64x/1.12.2/')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Bedrock-32x/1.16.210/textures`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Bedrock-32x', 'Jappa-1.16.210', COMMIT_MESSAGE, './texturesPush/Compliance-Bedrock-32x/1.16.210')
	...
	if (!isEmptyDir(`./texturesPush/Compliance-Bedrock-64x/1.16.210/textures`)) {
		await githubPush('Compliance-Resource-Pack', 'Compliance-Bedrock-64x', 'Jappa-1.16.210', COMMIT_MESSAGE, './texturesPush/Compliance-Bedrock-64x/1.16.210')

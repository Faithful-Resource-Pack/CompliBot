...
module.exports = {
  ...
  async execute(client, message, args) {
		...
		//if (message.author.id != uidR) return warnUser(message, 'This command is currently disabled due to updating to 21w19a, please try again in a few minutes.');
    ...
    async function getMultipleTexture(size, results, index) {
      ...
      var embed = new Discord.MessageEmbed()
				//.setAuthor('Note: this command isn\'t updated for 21w19a yet')
    ...
    function getTexture(type, name, index) {
      ...
      if (type == '16') imgURL = 'https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/21w18a/assets/' + name;

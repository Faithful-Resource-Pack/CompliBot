  ...
  async execute(client, message, args) {
    ...
    async function getMultipleTexture(size, results, index) {
      ...
      var embed = new Discord.MessageEmbed()
				.setAuthor('Note: this command isn\'t updated for 21w16a yet')
    ...
    function getTexture(type, name, index) {
      ...
      if (type == '16') imgURL = 'https://raw.githubusercontent.com/InventivetalentDev/minecraft-assets/21w15a/assets/' + name;

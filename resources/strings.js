...
const COMMAND_USES_DISABLED = 'Nobody (disabled)'
...
// color command
const COLOR_RGB_NO_VALUES = '**RGB**: You must specify **3** values.'
const COLOR_RGB_WRONG_VALUES = '**RGB**: Values must be between **0 & 255**.'
const COLOR_RGBA_NO_VALUES = '**RGBa**: You must specify **4** values.'
const COLOR_RGBA_WRONG_VALUES = '**RGBa**: **R**, **G** & **B** values must be between **0 & 255**.'
const COLOR_RGBA_ALPHA_VALUE = '**RGBa**: The alpha value must be a float between **0 & 1**.'
const COLOR_HSL_NO_VALUES = '**HSL**: You must specify **3** values.'
const COLOR_HSL_DEGREE_VALUE = '**HSL**: **Degree** value must be between **0 & 360**.'
const COLOR_HSL_SL_VALUES = '**HSL**: **S** & **L** values must be between **0 & 100**.'
const COLOR_HSV_NO_VALUES = '**HSV**: You must specify **3** values.'
const COLOR_HSV_DEGREE_VALUE = '**HSV**: **Degree** value must be between **0 & 360**.'
const COLOR_HSV_SV_VALUES = '**HSV**: **S** & **V** values must be between **0 & 100**.'
const COLOR_CMYK_NO_VALUES = '**CMYK**: You must specify **4** values.'
const COLOR_CMYK_WRONG_VALUES = '**CMYK**: Values must be between **0 & 100**.'
const COLOR_HEX_WRONG_VALUE = '**HEX**: Invalid hexadecimal value, accepted characters are **0 to 9** & **A to F**.'
const COLOR_HEX_WRONG_DIGITS = '**HEX**: You must specify **3 __or__ 6 __or__ 8** digits.'
...
module.exports = {
	...
	COLOR_RGB_NO_VALUES,
	COLOR_RGB_WRONG_VALUES,
	COLOR_RGBA_NO_VALUES,
	COLOR_RGBA_WRONG_VALUES,
	COLOR_RGBA_ALPHA_VALUE,
	COLOR_HSL_NO_VALUES,
	COLOR_HSL_DEGREE_VALUE,
	COLOR_HSL_SL_VALUES,
	COLOR_HSV_NO_VALUES,
	COLOR_HSV_DEGREE_VALUE,
	COLOR_HSV_SV_VALUES,
	COLOR_CMYK_NO_VALUES,
	COLOR_CMYK_WRONG_VALUES,
	COLOR_HEX_WRONG_VALUE,
	COLOR_HEX_WRONG_DIGITS,
